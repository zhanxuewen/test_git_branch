...
class ExportWordSentence extends Command
{
     ...
     * @var string
     */
    protected $signature = 'export:word:sentence ';
    ...
    public function handle()
    {
        ...
        foreach ($this->filePath as  $file) {
            ...
            if (count($contents) < 2) \Log::info($file_tmp);
...
//                if ('单词'  == $content[0]) continue;
//
//                if (empty($content[0]) && empty($content[1])
//                    && empty($content[2]) && empty($content[3]))
//                    continue;
//
//                $create_data[] = [
//                    'path' => $path,
...
//            }
//
//            \DB::table('excel_upload')->insert($create_data);
//            echo '+';
//            continue;
...
//                    $label_ids = $content[$key_tran['label_ids']];
                ...
                \DB::table('excel_2')->insert($create_data);
                echo '+';
            }
